        ...
        root = new RootNode(this,
            new Sequence(
                new Fallback(
                    ...
                    new PackedBomber(approachDistance, pauseTime, dashSpeed, dashAcceleration, dashAngularSpeed, explosionSize, explosionDamage, explosion, ExplosionEffect.noEffect, shielder, "ShieldTarget")
                    ),
